          ...
          children: <Widget>[
            ...
            TextFormField(
              ...
              decoration: InputDecoration(
                ...
                filled: true,
                fillColor: Colors.grey[800], // Đặt màu nền của TextFormField
                border: OutlineInputBorder(), // Đặt bo góc cho TextFormField
                prefixIcon: Icon(
                  Icons.attach_money,
                  color: Colors.blue, // Color of the email icon
                ),
              ),
              style: TextStyle(
                color: Colors.white,
              ...
              children: List.generate(
                ...
                (index) => GestureDetector(
                  ...
                  child: Chip(
                    ...
                    backgroundColor:
                        selectedAmenities[index] ? Colors.blue : null,
                  ),
                ),
              ),
            ),
